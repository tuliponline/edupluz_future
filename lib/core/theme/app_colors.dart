...
class AppColors {
  // Primary Colors
  static const Color primary = Color(0xFFE3A76F);
  static const Color secondary = Color(0xFF757575);

  // Background Colors
  static const Color background = Color(0xFFFAFAFA);
  static const Color surfaceBackground = Color(0xFFF5F5F5);
  static const Color splashBackground = Color(0xFFF8F1EA);

  // Text Colors
  static const Color textPrimary = Color(0xFF1A1A1A);
  static const Color textSecondary = Color(0xFF757575);
  static const Color textDisabled = Color(0xFFBDBDBD);
  static const Color textLink = Color(0xFFE3A76F);
  ...
  static const Color textFieldFillColor = Color(0xFFFBF7F2);

  //snackbar
  static const Color snackbarBackground = Color(0xFFFEF3F2);
}
